  ...
  <div class="backdrop"></div>
	...
	<div class="site-nav">
		...
		<?php if ( $build_overlay ) { ?>
			<a class="hamburger" data-action="toggle-overlay" data-overlay-id="menu-overlay" href="#menu-overlay" title="more stuff here"><span aria-label="Toggle Overlay"></span></a> <span class="morestuff">&laquo; more...</span> 
		<?php } ?>
	</div>
